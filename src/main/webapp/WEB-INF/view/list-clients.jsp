...
<html xlmns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <c:forEach var="p" items="${listClients}">
            ...
            <td ><c:out value="${p.getAdresse()}"/></td> 
            <td ><c:out value="${p.getZip()}"/></td>            
            <td ><c:out value="${p.getVille()}"/></td>            
            <td ><c:out value="${p.getTel()}"/></td>            
            ...
            <td >
                <form action="/list-lines-client" method="get">
                    <input type="hidden" name="id" value="${p.getId()}">
                    <input type="submit" value="solde" class="btn btn-warning" >
                </form> 
            </td>
        </tbody>
    </c:forEach>
