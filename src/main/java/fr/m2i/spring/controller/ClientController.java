...
public class ClientController {
    ...
    @Autowired
    public ClientController(LinesRepository linesRepository, LinesService linesService, ClientRepository clientRepository, ClientService clientService) {
    ...
    public String addClient(ModelMap modelclient) {
